		...
		while (true) {
			...
			case 3:
				...
				for (int i = 0; i < 3; i++) {
					...
					if (a > y) {
						if (y > z) {
							System.out.println("1등 :" + a + "2등:" + y + "3등:" + z);
						} else if (z > y) {
							System.out.println("1등 :" + a + "2등:" + z + "3등:" + y);
						}
					} else if (y > a) {
						if (a > z) {
							System.out.println("1등 :" + y + "2등:" + a + "3등:" + z);
						} else if (z > a) {
							System.out.println("1등 :" + y + "2등:" + z + "3등:" + a);
						}
					} else if (z > a) {
						if (a > y) {
							System.out.println("1등 :" + z + "2등:" + a + "3등:" + y);
						} else if (y > a) {
							System.out.println("1등 :" + z + "2등:" + y + "3등:" + a);
						}
					}
